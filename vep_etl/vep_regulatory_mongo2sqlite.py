...
for v in veps.find( { '$or': [{ "transcript_consequences.polyphen_prediction" : { '$in' : ["probably_damaging",
    ...
    variant = {
        ...
        'colocated_variants'  : [ { 'aa_allele'         : cv.get('aa_allele'),
         ...
         'regulatory_features'   : [ {'regulatory_feature_id' : rfc['regulatory_feature_id'],
                                      'eas_maf'               : rfc.get('eas_maf'),
                                      'sas_maf'               : rfc.get('sas_maf'),                 
                                      'impact'                : rfc['impact'],
