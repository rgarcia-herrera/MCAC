...
depth_files = [
    ...
    'depth_basespace/4.tsv',
    'depth_basespace/5.tsv',
    'depth_basespace/6.tsv',
    'depth_basespace/7.tsv',
    'depth_basespace/8.tsv',
    'depth_basespace/9.tsv',
