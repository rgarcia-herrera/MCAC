...
for CSV in `find /home/rgarcia/MCAC/vcf/caem_fvi_rigo -iname '*csv' | sort`
do
    DIROUT=`dirname $CSV`
...
for CSV in `ls /home/rgarcia/MCAC/vcf/family*csv | sort`
do
    DIROUT=`dirname $CSV`
    OUT=`basename $CSV .csv`
...
for CSV in `ls /home/rgarcia/MCAC/vcf/caem_fvi_rigo/family*csv | sort`
do
    DIROUT=`dirname $CSV`
    OUT=`basename $CSV .csv`
